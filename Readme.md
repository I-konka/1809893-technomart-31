...
* Студент: [Ирина Кононова](https://up.htmlacademy.ru/htmlcss/31/user/1809893).
...
[Откройте мастер-репозиторий](https://github.com/htmlacademy-htmlcss/1809893-technomart-31) и нажмите кнопку «Fork» в правом верхнем углу. Репозиторий из Академии скопируется в ваш аккаунт.
